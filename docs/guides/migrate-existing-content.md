...
under a month concept and the slug comes out `15-my-trip`, the day bleeding into the part of the URL
meant to read clean. Rename the file to `2024-03-my-trip.md` instead, and the slug is
