# Invisible-craft polish arc log (2026-07-16)

One line per iteration (probe, verdict, why); distilled into the settle-time decisions entry and
removed when the arc closes. Rubric: `2026-07-15-admin-resolved-polish-brief.md`. Branch:
`design/invisible-craft-polish`.
