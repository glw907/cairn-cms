...
- `CairnAdminRoutes`: { load: (event: CairnEvent<CairnEnv>) => Promise<AdminData>; actions: { request: (event: CairnEvent<CairnEnv>) => Promise<RequestResult>; confirm: (event: CairnEvent<CairnEnv>) => Promise<ActionFailure<{ error: string }>>; logout: (event: CairnEvent<CairnEnv>) => Promise<ActionFailure<{ error: string }>>; create: (event: CairnEvent<CairnEnv>) => Promise<ActionFailure<CreateFailure>>; save: (event: CairnEvent<CairnEnv>) => Promise<ActionFailure<NavSaveFailure>>; settingsSave: (event: CairnEvent<CairnEnv>) => Promise<ActionFailure<SettingsSaveFailure>>; vocabularySave: (event: CairnEvent<CairnEnv>) => Promise<ActionFailure<VocabularySaveFailure>>; upload: (event: CairnEvent<CairnEnv>) => Promise<ActionFailure<MediaUploadFailure> | UploadResult>; publish: (event: CairnEvent<CairnEnv>) => Promise<ActionFailure<SaveFailure>>; discard: (event: CairnEvent<CairnEnv>) => Promise<ActionFailure<{ error: string }>>; rename: (event: CairnEvent<CairnEnv>) => Promise<ActionFailure<RenameFailure>>; dictionaryAdd: (event: CairnEvent<CairnEnv>) => Promise<ActionFailure<DictionaryAddFailure> | DictionaryAddResult>; tidy: (event: CairnEvent<CairnEnv>) => Promise<ActionFailure<TidyFailure> | TidyResult>; delete: (event: CairnEvent<CairnEnv>) => Promise<ActionFailure<DeleteRefusal>>; mediaDelete: (event: CairnEvent<CairnEnv>) => Promise<ActionFailure<MediaDeleteRefusal>>; mediaUpdate: (event: CairnEvent<CairnEnv>) => Promise<ActionFailure<MediaUpdateFailure>>; mediaUpload: (event: CairnEvent<CairnEnv>) => Promise<ActionFailure<MediaUploadFailure> | UploadResult>; mediaLibraryUpload: (event: CairnEvent<CairnEnv>) => Promise<ActionFailure<MediaUploadFailure> | UploadResult>; mediaReplacePreview: (event: CairnEvent<CairnEnv>) => Promise<ActionFailure<MediaReplaceFailure> | MediaReplacePreviewPlan>; mediaReplace: (event: CairnEvent<CairnEnv>) => Promise<ActionFailure<MediaReplaceFailure>>; mediaAltPreview: (event: CairnEvent<CairnEnv>) => Promise<ActionFailure<MediaAltPropagateFailure> | MediaAltPreviewPlan>; mediaAltPropagate: (event: CairnEvent<CairnEnv>) => Promise<ActionFailure<MediaAltPropagateFailure>>; mediaBulkDelete: (event: CairnEvent<CairnEnv>) => Promise<ActionFailure<MediaBulkFailure> | MediaBulkDeleteResult>; mediaOrphanScan: (event: CairnEvent<CairnEnv>) => Promise<ActionFailure<MediaBulkFailure> | MediaOrphanScanResult>; mediaOrphanPurge: (event: CairnEvent<CairnEnv>) => Promise<ActionFailure<MediaBulkFailure> | MediaOrphanPurgeResult>; publishAll: (event: CairnEvent<CairnEnv>) => Promise<ActionFailure<{ error: string }>>; editorAdd: (event: CairnEvent<CairnEnv>) => Promise<ActionFailure<{ error: string }> | { ok: true }>; editorRemove: (event: CairnEvent<CairnEnv>) => Promise<ActionFailure<{ error: string }> | { ok: true }>; editorSetRole: (event: CairnEvent<CairnEnv>) => Promise<ActionFailure<{ error: string }> | { ok: true }> }; shellLoad: (event: CairnEvent<CairnEnv>) => Promise<{ shell: AdminShellData }> }
- `CairnEnv`: { AUTH_DB?: D1Database; PUBLIC_ORIGIN?: string; CAIRN_DEV_BACKEND?: string | boolean; EMAIL?: EmailSender; GITHUB_APP_PRIVATE_KEY_B64?: string }
