...
triage finished the Next-tier entry "Re-source the page-only `[candidate]` bullets", which was
deleted: no bullet sourced only to a page remains. See Clearings.
