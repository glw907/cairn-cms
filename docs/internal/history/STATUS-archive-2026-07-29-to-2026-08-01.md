...
design-ratchet minor (`0.92.0`), the xcathletes seams pass as planned before it executed, and
the ASC seams pass-one entry (the `0.93.0` publish) that pass two superseded.
...
## Superseded 2026-08-01 (ASC seams pass one shipped and published as `0.93.0`)
