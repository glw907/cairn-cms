# STATUS archive: 2026-08-04 to 2026-08-05

The auth-channel window and the AI-posture pass as STATUS carried them, superseded when
`0.94.0-rc.1` was cut on 2026-08-05. Read them as history, not as current state.

## The auth-channel window, as it stood before the RC cut
...
[`docs/internal/2026-08-04-auth-channel-consumer-proof-harvest.md`](../record/2026-08-04-auth-channel-consumer-proof-harvest.md).
...
[`docs/internal/2026-08-03-ambient-defaults-audit.md`](../record/2026-08-03-ambient-defaults-audit.md).
