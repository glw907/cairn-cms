...
- [Auth channel (`/auth-channel`)](./auth-channel.md): the server-only factory for a site's own second-audience login channel, request/confirm/logout over a site-owned D1 binding.
