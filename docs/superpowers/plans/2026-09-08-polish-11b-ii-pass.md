...
own paint-branch table (the produced-moved-list tasks 1, 2, 5 and the capture-pair tasks 3, 4),
run the full fence string unchanged. Task 6 (records, no rendered surface) drops the e2e clause.
