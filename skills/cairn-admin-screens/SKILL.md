...
running dev server, both themes) runs twenty-nine rules across two modes: twelve static, all
error tier, and seventeen rendered, seven error and ten advisory. Full descriptions live in
