...
<header class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
  ...
  <button type="button" class="btn btn-sm shrink-0 border-transparent bg-neutral/85 text-neutral-content shadow-none hover:bg-base-content hover:text-base-100" onclick={onUploadButtonClick}>
...
{#if data.assets.length === 0}
  ...
  <div class="flex min-h-[52vh] flex-col items-center justify-center gap-4 px-6 py-14 text-center">
    ...
    <div class="mt-1 flex flex-col items-center gap-2 rounded-box border border-dashed border-[var(--cairn-card-border)] px-7 py-5 text-muted">
      <button type="button" class="btn btn-sm border-transparent bg-neutral/85 text-neutral-content shadow-none hover:bg-base-content hover:text-base-100" onclick={onUploadButtonClick}>
