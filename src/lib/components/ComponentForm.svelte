...
<script lang="ts">
   ...
   *  `npm run check` here. multiselect, image, object, reference, and array never reach a real
   *  component attribute (`checkComponentAttributes` rejects them at `defineComponent`), but `def.attributes`
