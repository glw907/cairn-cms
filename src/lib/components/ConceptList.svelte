...
<header class="mb-6 flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between">
  ...
  <div class="flex flex-col gap-3 sm:flex-1 sm:flex-row sm:flex-wrap sm:items-center sm:justify-end">
    ...
    <button type="button" class="btn btn-sm w-full shrink-0 border-transparent bg-neutral text-neutral-content shadow-none hover:bg-base-content hover:text-base-100 sm:w-auto" aria-haspopup="dialog" onclick={() => createDialog?.showModal()}>
...
{#if data.entries.length === 0}
  ...
  <div class="flex min-h-[56vh] flex-col items-center justify-center gap-4 px-6 py-16 text-center">
    ...
    <button type="button" class="btn btn-sm border-transparent bg-neutral text-neutral-content shadow-none hover:bg-base-content hover:text-base-100" aria-haspopup="dialog" onclick={() => createDialog?.showModal()}>
      <PlusIcon class="h-4 w-4" /> New {createNoun}
    </button>
  </div>
{:else}
