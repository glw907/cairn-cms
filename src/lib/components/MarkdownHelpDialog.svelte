...
<dialog class="modal" aria-labelledby="cairn-markdown-help-title" bind:this={dialog}>
  <div class="modal-box">
    ...
    <table class="table table-sm">
      <thead>
        <tr>
          <th class="type-label font-semibold uppercase tracking-[0.08em] text-muted">Type this</th>
          <th class="type-label font-semibold uppercase tracking-[0.08em] text-muted">What it makes</th>
        </tr>
      </thead>
      <tbody>
