// cairn-cms: the entry create/edit/save/publish/discard/delete/rename cycle for a single entry.
...
// `export const load = routes.editLoad`. The admin shell payload, the Help home, and the concept
// list moved out to content-routes-shell.ts and content-routes-list.ts; the public preview
// link's mint and revoke actions moved out to content-routes-preview.ts. This module re-exports
// their types so an existing importer of this path keeps compiling unchanged.
...
import { manifestEntryFromFile, parseManifest, serializeManifest, stampFirstPublish, upsertEntry, removeEntry, inboundLinks, inboundReferences, inboundIncludes, type Manifest, type ManifestEntry, type LinkTarget, type InboundLink } from '../content/manifest.js';
...
/**
 * Build the per-entry create/edit/save/publish/discard/delete/rename cycle, closed over the
 *  shared content-routes context.
 */
