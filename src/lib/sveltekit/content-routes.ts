...
export function createContentRoutes(runtime: CairnRuntime, deps: ContentRoutesDeps = {}) {
  ...
  return {
    ...
    mediaLibraryUpload: media.mediaLibraryUpload,
    mediaDeleteAction: media.mediaDeleteAction,
    mediaBulkDelete: media.mediaBulkDelete,
    mediaOrphanScan: media.mediaOrphanScan,
    mediaPurgeOrphans: media.mediaPurgeOrphans,
    mediaUpdateAction: media.mediaUpdateAction,
    mediaReplacePreview: media.mediaReplacePreview,
    mediaReplaceApply: media.mediaReplaceApply,
    mediaAltPreview: media.mediaAltPreview,
    mediaAltApply: media.mediaAltApply,
    addDictionaryWord: dictionary.addDictionaryWord,
