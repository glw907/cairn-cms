...
// machinery the plugin shares with the cairn-manifest and cairn-doctor bins, including the
// site-facts.json contract cairnManifest's buildStart also verifies, lives in `./internal.js`,
// which those bins and their unit tests import by relative path, never through this subpath: a
// build-time helper that is not itself a Vite plugin belongs internal, not here.
//
