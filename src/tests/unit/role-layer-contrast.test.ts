...
// BRANCH: guaranteed-value. The measured ratio table (light 50%->3.71 .. 100%->14.05; dark
// 50%->1.50 .. 80%->5.14 .. 100%->13.39, from looping roleFloor(theme, alpha) over 50%-100% alpha
// in 5% steps) shows a single base-content opacity step CAN clear 4.5 on
