...
// ValidateSiteID reports whether id matches the Node CLI's site id shape:
// one or more lowercase-alphanumeric segments joined by hyphens, ending in a
// six-character lowercase-alphanumeric suffix.
...
// ValidateDomain reports whether domain is a bare LDH DNS name: no scheme,
// userinfo, port, path, query, fragment, or IP literal, and every
// dot-separated label is letters, digits, and interior hyphens only.
//
...
// belongs to Adopt (Task 18), not this parser.
