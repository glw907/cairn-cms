...
var exportedSurface = []string{
	...
	"Frame",
	"GlyphSet", "Glyphs",
	"MarshalAdoptList", "MarshalLogs", "MarshalSite", "MarshalSiteLine", "MarshalSitesList",
	"MarshalSummary",
	"AdoptCandidate", "AdoptListSchemaVersion", "LogsSchemaVersion", "SiteJSON", "SiteListEntry",
